...
На рисунке~\ref{chart:time} представлен график, иллюстрирующий зависимость времени выполнения запроса на выборку из таблицы товаров от количества записей и от наличия индекса.
...
Результаты показывают, что при увеличении количества записей в таблице с индексом скорость выполнения запроса практически не меняется, в то время как при отсутствии индекса наблюдается увеличение времени выполнения запросов.
