...
За основу выбирается функция добавления схемы (листинги~\ref{lst:add_chart_json:1}~--~\ref{lst:add_chart_json:2}). 
...
\subsection{Зависимость времени выполениня запроса от наличия индексов в базе данных}

На рисунке~\ref{chart:time} представлен график зависимости времени выполнения запроса от количества записей и от наличия индекса.
